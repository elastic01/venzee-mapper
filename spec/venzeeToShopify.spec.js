...
describe('venzeeToShopify', function () {
    ...
    let venzeeToShopify = require('../lib/venzeeToShopify.js');
    ...
    it('should process all records from msg.body.records', function (done) {

        let emitter = new EventEmitter();
        spyOn(emitter, 'emit').and.callThrough();
        emitter.on('end', onEnd);

        let msg = {body: {"records": [venzeeRecord, venzeeRecord]}};
